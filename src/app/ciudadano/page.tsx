...
export default function HomePage() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      setMercados(mercs);
      const casera = await getCaseraById('c2000000-0000-0000-0000-000000000002');
              ...
              <div className="flex items-start gap-4 relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[11px] text-[var(--texto-suave)] flex items-center gap-1 mb-2">
                    <Store size={10}/> M. Rodríguez • Puesto {caseraMadrina.puesto}
                  </p>
                  <p className="text-[10px] font-bold text-[var(--texto-fuerte)] bg-[var(--bg-tarjeta)]/80 px-2 py-1.5 rounded-md inline-block border border-[var(--borde)] shadow-sm leading-tight">
                    <span className="text-[var(--verde-palta)] block mb-0.5">Madrina Asignada: Doña Flora</span>
